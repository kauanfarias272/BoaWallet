...
const POPULAR_APPS = [
  ...
  { name: 'Amazon Prime', logo: 'https://logo.clearbit.com/amazon.com' },
  ...
  { name: 'HBO Max', logo: 'https://logo.clearbit.com/hbomax.com' },
  { name: 'Crunchyroll', logo: 'https://logo.clearbit.com/crunchyroll.com' },
  { name: 'Google One', logo: 'https://logo.clearbit.com/google.com' },
  { name: 'iCloud', logo: 'https://logo.clearbit.com/apple.com' },
