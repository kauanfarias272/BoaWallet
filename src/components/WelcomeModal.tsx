...
export function WelcomeModal({ onSave, onLogin }: WelcomeModalProps) {
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#1a1a1a] rounded-2xl shadow-xl w-full max-w-md p-8 text-center border border-gray-800">
        ...
        <button
          type="button"
          onClick={onLogin}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 mb-6 bg-white hover:bg-gray-100 text-gray-900 rounded-xl transition-colors font-medium shadow-sm"
        >
